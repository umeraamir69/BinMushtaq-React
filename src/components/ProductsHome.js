                                ...
                                <div id="slider" className="h-full flex lg:gap-8 md:gap-6 gap-14 items-center justify-start transition ease-out duration-700">
                                    {data.map((data, index) => (
                                        <Slide index={1} key={index}>
                                            <div className="flex flex-shrink-0 relative w-full sm:w-auto hover:scale-100">
                                                <img src={data.image} alt="sitting area" className="object-cover object-center w-full  " />
                                                <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
                                                    <h2 className="lg:text-xl leading-4 text-base lg:leading-5 text-white">{data.country}</h2>
                                                    <div className="flex h-full items-end pb-6">
                                                        <h3 className="text-xl lg:text-2xl font-semibold leading-5 lg:leading-6 text-white">{data.name}</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </Slide>
