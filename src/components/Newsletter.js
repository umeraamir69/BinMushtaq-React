    ...
    return (
        <div>
            ...
            <section class="relative py-20 md:py-24 overflow-hidden">
                <img class="absolute top-0 left-0" src="/images/news.png" alt="" />
                        ...
                        <div class="flex flex-wrap -mx-4 items-center">
                            ...
                            <div class="w-full lg:w-1/2 px-4">
                                <div class="relative pl-20 lg:pl-16 xl:pl-0 max-w-lg mx-auto">
                                    <img class="absolute w-125 h-125 object-contain bottom-0 left-0 -mb-32 sm:-mb-0 -ml-8 xs:-ml-20 md:-ml-40 lg:-ml-24 xl:-ml-52" src="/images/newsbg.png" alt="" />
                                    <img class="relative block w-full xl:max-w-sm lg:ml-auto" src="/images/fruits.jpg" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
