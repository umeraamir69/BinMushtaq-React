...
const Testimonials = () => {
    return (
        <div className="2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 px-4 py-9 ">
            <h1 className=" text-center lg:mb-20 mb-10 text-gray-800 font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 w-9/12 md:w-full mx-auto">Hear From Our Partners</h1>
            <div className=" relative md:flex justify-center items-center ">
                <div className="md:w-4/12 w-full">
                    ...
                    <Link href="/" className="hover:text-gray-800 focus:outline-none focus:text-black hover:underline text-sm leading-3 text-gray-600 cursor-pointer ">
                        See all reviews
                    </Link>
                </div>
                                        ...
                                        <div className="mb-6">
                                            <svg width="71" height="25" viewBox="0 0 71 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    ...
                                                    fill="#1F2937"
                                                />
                                                <path d="M60.6706 19.0529L55.5537 5.76172H59.014L62.3272 14.9494L65.5908 5.76617H69.0512L61.9061 24.4137H58.4458L60.6706 19.0529ZM71.0006 17.2095C71.0006 18.5892 70.0681 19.509 68.7299 19.509C67.4186 19.509 66.484 18.5351 66.484 17.2095C66.484 15.884 67.4179 14.91 68.7299 14.91C70.0674 14.91 71.0006 15.884 71.0006 17.2095Z" fill="#1F2937" />
                                            </svg>
                                        </div>
